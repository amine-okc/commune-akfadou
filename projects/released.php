...
<head>
    ...
    <title>Projets achevés - Commune d'Akfadou</title>
...
<body>
    ...
    <!-- write here -->
                    ...
                    <div class="card mb-4 pagetitle shadow p-3 bg-white rounded">
                        <h1 class="page-title">Projets achevés</h1>
                    </div>
                </center>
    <div class="album py-5">
        <div class="container">
            <div class="row">
                ...
                <?php
                include("../dbconn.php");
                $sql = "SELECT *, DATE_FORMAT(date, \"%Y\") AS date from `projects`  where stat = 'achieved' ORDER BY id desc";
                ...
                if (mysqli_num_rows($result) == 0) { ?>
                    ...
                    <hr>
                    <center>
                        <h1 class="empty-title" style="font-size: 60pt;"><b>Aucun Projet</b></h1>
                    </center>
                    <hr><br><br>
                    <?php } else {
